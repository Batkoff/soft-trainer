...
class PromptTests(TestCase):
    def test_snapshot_survives_edit_and_old_version_is_available(self):
        EvaluationPrompt.objects.update_or_create(pk=1, defaults={"text": "Первый промпт"})
    ...
    def test_admin_edit_permissions_validation_and_audit(self):
        EvaluationPrompt.objects.update_or_create(pk=1, defaults={"text": SYSTEM_PROMPT})
        ...
        self.assertEqual(EvaluationPrompt.objects.get(pk=1).text, "Новые правила")
